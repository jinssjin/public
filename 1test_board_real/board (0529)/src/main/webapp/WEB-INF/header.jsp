...
<nav class="navbar navbarheader navbar-expand-lg navbar-light">
    <div class="container-fluid">
        <a class="navbar-brand" href="${pageContext.request.contextPath}/index.jsp"><i class="fa-solid fa-futbol"></i></a>
    ...
    <c:when test="${not empty sessionScope.user}">
        <a class="nav-link" href="${pageContext.request.contextPath}/board/BoardListAction.do">게시판</a>
    </c:when>
    <c:otherwise>
        <!-- 로그인 안 했을 때 보여줄 내용 -->
        <a class="nav-link" href="#" onclick="alert('로그인 후 이용 가능합니다.'); return false;">게시판</a>
    </c:otherwise>
</c:choose>
                </li>
            </ul>
