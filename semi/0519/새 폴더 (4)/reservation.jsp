    ...
    <div class="card p-4">
        ...
        <table class="table">
            ...
            <tr>
                <th>가격</th>
                <td>
                    <span id="originalPriceText" class="price-text text-danger fw-bold">${reservationInfo.price}원</span>
                    <span id="discountedPriceText" class="discounted-price text-success fw-bold d-none ms-2  d-none"></span>
                </td>
            </tr>
        </table>
