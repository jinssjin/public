...
public class CouponDAO {
    ...
    public void markCouponAsDeleted(int couponNum) {
        ...
        try (Connection conn = DBConnection.getConnection();
            ...
            System.out.println("markCouponAsDeleted() 에러: " + e.getMessage());
            e.printStackTrace();
        }
    }
    ...
    public void updateCouponUsage(int couponNum, int usedAmount) {
        String selectSql = "SELECT coupon_content, coupon_value FROM coupon WHERE coupon_num = ?";
        ...
        try (Connection conn = DBConnection.getConnection();
            ...
            if (rs.next()) {
                String content = rs.getString("coupon_content");
